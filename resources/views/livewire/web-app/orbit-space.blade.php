...
<div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full rounded-xl border-t border-r border-l border-blue-500 overflow-hidden relative">
    ...
    <div class="flex h-[980px]">
        <div class='flex '>
        <div class="w-[250px] shadow-md shadow-blue-500 relative border-r rounded-xl border-t border-b  mt-[92px] border-blue-500 p-4 flex flex-col space-y-4">
            ...
            <div class="rounded-lg border border-blue-500/60 p-10 flex justify-center mb-8">
            <div class="border-blue-500/50 flex items-center justify-center">
            ...
            <div class="rounded-lg border-[3px] border-blue-500 p-10 flex justify-center mb-8 relative after:content-[''] after:absolute after:inset-0 after:rounded-2xl after:border-1 after:border-blue-400/50 after:blur-[2px] after:z-[-1] shadow-[0_0_8px_rgba(59,130,246,0.3)]">
          ...
          <div class="flex-1 flex flex-col relative">
            ...
            <div class="flex-1  px-14 overflow-y-auto border-blue-500 shadow-md  shadow-blue-500 border-t border-b border-l rounded-xl ml-8 ">

    
    
            <div class="px-6 ">
              <h2 class="text-[#00BFFF] text-3xl py-12 text-center"># GENERAL CHAT</h2>
            </div>
            <div class='flex flex-col'>

            </div>
            <div class=" border h-[600px] border-blue-500 shadow-sm shadow-blue-500 rounded-lg p-4 mb-4">
              ...
              <div class='h-fit '>
            <div class="">
              <div class="flex items-center  border border-blue-500 rounded-lg p-5 shadow-blue-500 shadow-sm">
            ...
            <!-- <div class="p-4">
              <div class="flex items-center bg-gray-900 border border-blue-500/30 rounded-lg p-2">
                <button class="text-blue-400 px-2">
