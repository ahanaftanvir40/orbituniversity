...
<div class="grow flex items-center justify-center p-4">
    ...
    <div class="absolute inset-0 rounded-xl border-t border-r border-l border-blue-600 blur-[1px] z-[-1]"></div>
    <div class="absolute inset-0 rounded-xl border-t border-r border-l border-blue-600 blur-[4px] z-[-2]"></div>
    ...
    <div class="flex grow">
        ...
        <div class="w-[250px] shadow-md shadow-blue-500 relative border-r rounded-xl border-t border-b  mt-[92px] border-blue-600 p-4 flex flex-col space-y-4">
            ...
            <div class="rounded-lg border border-blue-600 p-10 flex justify-center mb-8 ">
          ...
          <div class="flex-1 flex flex-col relative">
            ...
            <div class="border border-blue-600  rounded-lg p-4 mb-4 relative after:content-[''] after:absolute after:inset-0 after:rounded-2xl after:border-1 after:border-blue-400/50 after:blur-[2px] after:z-[-1] shadow-[0_0_8px_rgba(59,130,246,0.3)]">
